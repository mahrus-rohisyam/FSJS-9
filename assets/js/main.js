...
/* -------------------------------- Function -------------------------------- */
function namaFunction (number) {        //Punya parameter
    //Action atau yang dikerjakan
    return number * number
}

function namaFunction2 () {             //Ngga punya parameter
    let a = 9
    let b = 3
    return a * b
}
...
const namaFungsi = () => {              //Arrow function ga pake param
    let a = 9
    let b = 3
    return a * b
}

const namaFungsi2 = (a, b) => {         //Arrow function pake param
    return a * b
}
